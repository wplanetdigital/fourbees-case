...
export const sendMail = (email, rememberToken) => {
  const mailOptions = {
    ...
    to: email,
    subject: `Código de verificação: ${rememberToken}`,
    attachments: [
      {
                            ...
                            <tr>
                                <td class="wrapper">
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <p><b>Olá, tudo bem?</b></p>
                                                <p>Código de autenticação abaixo para verificar o seu acesso a plataforma.</p>
                                                ...
                                                <p>O código acima expira em 15 minutos.<br />
