...
export const sendMail = (email, rememberToken) => {
  const mailOptions = {
    ...
    <html>
        ...
        <body>
        <span class="preheader">Confirme seu e-mail para aproveitar ao máximo nossa plataforma!</span>
                              ...
                              <td class="wrapper">
                                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                          <td>
                                              <p><b>Bem-vindo!</b></p>
                                              <p>Obrigado por se registrar. <br/>
                                              Antes de prosseguirmos, é necessário confirmar o seu endereço de e-mail.</p>
                                                          ...
                                                          <td align="left">
                                                              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                                  <tbody>
                                                                      <tr>
                                                                          <td>
                                                                              <a href="${process.env.APP_URL}/auth/activate/${rememberToken}" target="_blank">Confirme seu endereço de e-mail</a>
                                                                          </td>
                                                                      </tr>
                                                                  </tbody>
                                                              </table>
                                              ...
                                              <p>Valorizamos muito seu feedback, ideias e sugestões. Nosso objetivo é realmente simplificar sua vida, então, se acredita que podemos melhorar ou tem alguma sugestão, compartilhe conosco por e-mail em: <a href="mailto:${process.env.MAIL_USER}"><b>${process.env.MAIL_USER}</b></a> </p>
                                              <p>Obrigado! </p>
                                              <p>Atenciosamente,<br/>
